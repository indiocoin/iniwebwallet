/**
 * Indiocoin Wallet by Carsen Klock, Main app.js
 * Module dependencies.
 */
...
app.listen(app.get('port'), () => {
  console.log('%s Indiocoin Wallet is running at http://localhost:%d in %s mode', chalk.green('✓'), app.get('port'), app.get('env')); 
